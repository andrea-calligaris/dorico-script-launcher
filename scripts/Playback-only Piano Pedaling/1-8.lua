...
app:doCommand([[UI.InvokePropertyChangeValue?Type=kEventColour&Value=string: "#40000000"]])

app:doCommand([[UI.InvokePropertyChangeValue?Type=kPedalLineStartText&Value=string: "1/8"]])
app:doCommand([[UI.InvokePropertyChangeValue?Type=kPedalLineStartLevel&Value=string: "1/8"]])
app:doCommand([[UI.InvokePropertyChangeValue?Type=kPedalLineEndLevel&Value=string: "1/8"]])
app:doCommand([[UI.InvokePropertyChangeValue?Type=kPedalLineContinuationLineWidth&Value=string: "1/8"]])
