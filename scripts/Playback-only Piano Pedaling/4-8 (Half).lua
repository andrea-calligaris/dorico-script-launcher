...
app:doCommand([[UI.InvokePropertyChangeValue?Type=kEventColour&Value=string: "#85000000"]])

app:doCommand([[UI.InvokePropertyChangeValue?Type=kPedalLineStartText&Value=string: "Half"]])
...
app:doCommand([[UI.InvokePropertyChangeValue?Type=kPedalLineContinuationLineWidth&Value=string: "1/2"]])
